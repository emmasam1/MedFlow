...
const CoverageMonitor = ({ shifts }) => {
  ...
  const getStats = (dept) => {
    ...
    const active = shifts.filter(
      (s) => s.department === dept && !s.isOnCall,
    ).length;
      ...
      <div className="flex items-center gap-1 bg-slate-200/50 p-1.5 rounded-2xl w-fit mb-8">
        {tabs.map((tab) => (
          <button
            ...
            className={`relative px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest transition-colors flex items-center gap-2 ${
              currentTab === tab.id
                ? "text-blue-600"
                          ...
                          <td className="px-6 py-5 rounded-r-2xl text-right">
                            <div className="flex items-center justify-end gap-1">
                              ...
                              <button
                                ...
                                className={`p-2 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg cursor-pointer ${
                                  staff.isOnCall
