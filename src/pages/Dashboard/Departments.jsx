      ...
      <AnimatePresence mode="wait">
        {!selectedDept ? (
            ...
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Manage units and staff allocation.
                </p>
              </div>
              <motion.button
                {...buttonMotion}
              ...
              {departments.map((dept) => (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div
                      className={`p-2 rounded-lg ${getColorClasses(dept.color)}`}
                    >
                      {dept.icon}
                    </div>
                    <span
                      className={`text-[9px] font-bold uppercase px-2 py-0.5 rounded-full ${dept.status === "Critical" ? "bg-red-100 text-red-600" : dept.status === "Full" ? "bg-orange-100 text-orange-600" : "bg-green-100 text-green-600"}`}
                    >
                      {dept.status}
                    </span>
                  </div>
          ...
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden min-h-[600px]"
          >
            {/* Header */}
            ...
            <div className="p-8">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-slate-50 p-6 rounded-2xl border border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400">
                      ...
                      <p className="italic text-sm font-medium">
                        No recent incidents reported in this unit.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center">
                    <h3 className="font-bold text-slate-800 flex items-center gap-2">
                      ...
                      />{" "}
                      HOD’s Current Roster Allocation
                    </h3>
                    <span className="text-[10px] bg-amber-50 text-amber-600 border border-amber-100 px-3 py-1 rounded-full font-black uppercase">
                      Admin Audit Mode
                    </span>
                  </div>
                        ...
                        {[
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              <span
                                className={`px-2 py-1 rounded-full text-[10px] font-bold ${staff.status === "On-Duty" ? "bg-green-50 text-green-600" : "bg-slate-100 text-slate-400"}`}
                              >
                                {staff.status}
                              </span>
                            </td>
              ...
              {activeTab === "Billing" && (
                <div className="flex flex-col items-center justify-center py-20 text-slate-400 italic">
                  ...
                  />
                  <p>
                    Department Revenue & Billing reports are being compiled...
                  </p>
                </div>
              )}
            </div>
